...
const data = [
    ...
    { text: "your presence makes me feel like loving you is the bare minimum", img: "photo (82).jpg" },
    ...
    { text: "your laughter is my favourite sound", img: "photo (91).jpg" },
    { text: "you have the best curves ever made", img: "photo (77).jpg" },
    { text: "I would choose you in every single universe", img: "photo (77).jpg" },
    ...
    { text: "the way you move is mesmerizing", img: "photo (12).jpg" },
    ...
    { text: "you're my comfort person", img: "photo (66).jpg" },
    { text: "I can tell you everything", img: "photo (66).jpg" },
    { text: "you're trustworthy", img: "photo (57).jpg" },
    { text: "you understand me", img: "photo (59).jpg" },
    { text: "life is more enjoyable with you", img: "photo (61).jpg" },
    ...
    { text: "you give genuinely good advice", img: "photo (6).jpg" },
    { text: "you're polite", img: "photo (2).jpg" },
    { text: "you're the aw to my tism", img: "photo (82).jpg" },
    { text: "you listen to my stupid shit too", img: "photo (92).jpg" },
    ...
    { text: "you don't leave me alone", img: "photo (21).jpg" },
    { text: "I wanna marry you someday even if it sounds impossible", img: "photo (7).jpg" },
    { text: "you're art in motion", img: "photo (5).jpg" },
    { text: "you're graceful", img: "photo (62).jpg" },
    { text: "you're my favourite thought", img: "photo (67).jpg" },
    { text: "you're mine", img: "photo (19).jpg" },
    { text: "you're you", img: "photo (72).jpg" },
    { text: "you're magnetic", img: "photo (72).jpg" },
    { text: "you're cute", img: "photo (52).jpg" },
    { text: "your scent is my favourite drug", img: "photo (17).jpg" },
